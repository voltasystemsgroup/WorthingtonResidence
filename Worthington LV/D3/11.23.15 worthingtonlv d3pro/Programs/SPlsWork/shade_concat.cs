...
namespace CrestronModule_SHADE_CONCAT
{
    public class CrestronModuleClass_SHADE_CONCAT : SplusObject
    {
    ...
    public CrestronModuleClass_SHADE_CONCAT ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
