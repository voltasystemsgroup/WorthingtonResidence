...
namespace UserModule__AS__LIGHTINGSYSTEM_V1_0_0
{
    public class UserModuleClass__AS__LIGHTINGSYSTEM_V1_0_0 : SplusObject
    {
        ...
        AdaptCore.PD_LightingSystem MYBRIDGE;
        ...
        private void FNREFRESHINPUTS (  SplusExecutionContext __context__ ) 
            ...
            ushort __FN_FORSTART_VAL__1 = (ushort) ( 41 ) ;
...
{
    MYBRIDGE  = new AdaptCore.PD_LightingSystem();
    
    
}

public UserModuleClass__AS__LIGHTINGSYSTEM_V1_0_0 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
