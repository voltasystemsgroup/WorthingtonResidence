...
namespace UserModule__AS__DISPLAY_V1_2_0
{
    public class UserModuleClass__AS__DISPLAY_V1_2_0 : SplusObject
    {
        ...
        object INIT_OnPush_0 ( Object __EventInfo__ )
            ...
            try
            {
                ...
                MYBRIDGE . FriendlyId = (ushort) ( DISPLAY_NUMBER  .Value ) ; 
                __context__.SourceCodeLine = 138;
                MYBRIDGE . NumInputs = (ushort) ( NUMBER_OF_INPUTS  .Value ) ; 
                __context__.SourceCodeLine = 139;
                MYBRIDGE . AccessLevel = (ushort) ( ACCESS_LEVEL  .Value ) ; 
                __context__.SourceCodeLine = 140;
                MYBRIDGE . FriendlyName  =  ( DISPLAY_NAME + Functions.ItoA (  (int) ( DISPLAY_NUMBER  .Value ) )  )  .ToString() ; 
...
{
    MYBRIDGE  = new AdaptCore.PD_Display();
    
    
}

public UserModuleClass__AS__DISPLAY_V1_2_0 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
...
const uint DISPLAY_NAME__Parameter__ = 11;
