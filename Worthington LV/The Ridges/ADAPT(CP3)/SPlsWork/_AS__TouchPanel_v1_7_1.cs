...
namespace UserModule__AS__TOUCHPANEL_V1_7_1
{
    public class UserModuleClass__AS__TOUCHPANEL_V1_7_1 : SplusObject
    {
        ...
        Crestron.Logos.SplusObjects.DigitalOutput ALLOW_TIMER;
        ...
        public void HANDLEALLOWTIMERFLAG ( object __sender__ /*AdaptCore.PD_Bridge SENDER */, AdaptCore.PD_ValueEventArgs ARGS ) 
            { 
            PD_Bridge  SENDER  = (PD_Bridge )__sender__;
            try
            {
                ...
                ALLOW_TIMER  .Value = (ushort) ( ARGS.SignalValue ) ; 
        ...
        object INIT_OnPush_0 ( Object __EventInfo__ )
            ...
            try
            {
                ...
                // RegisterEvent( MYBRIDGE , SETALLOWTIMERFLAGCHANGE , HANDLEALLOWTIMERFLAG ) 
                try { g_criticalSection.Enter(); MYBRIDGE .SetAllowTimerFlagChange  += HANDLEALLOWTIMERFLAG; } finally { g_criticalSection.Leave(); }
                ; 
...
public override void LogosSplusInitialize()
{
    ...
    CONTROL_LIST_BTN = new InOutArray<DigitalInput>( 100, this );
    ...
    MULTIROOM_SELECT_BTN = new InOutArray<DigitalInput>( 100, this );
    for( uint i = 0; i < 100; i++ )
    {
    ...
    ALLOW_TIMER = new Crestron.Logos.SplusObjects.DigitalOutput( ALLOW_TIMER__DigitalOutput__, this );
    m_DigitalOutputList.Add( ALLOW_TIMER__DigitalOutput__, ALLOW_TIMER );
    ...
    CONTROLLISTDIGITAL_FB = new InOutArray<DigitalOutput>( 100, this );
    for( uint i = 0; i < 100; i++ )
    {
    ...
    MULTIROOM_SELECT_FB = new InOutArray<DigitalOutput>( 100, this );
    for( uint i = 0; i < 100; i++ )
    {
    ...
    ROOMLISTITEMENABLE = new InOutArray<DigitalOutput>( 100, this );
    for( uint i = 0; i < 100; i++ )
    {
    ...
    ROOM_LIST_TEXT = new InOutArray<StringOutput>( 100, this );
    for( uint i = 0; i < 100; i++ )
    {
    ...
    CONTROLLISTSERIAL_FB = new InOutArray<StringOutput>( 100, this );
    for( uint i = 0; i < 100; i++ )
    {
    ...
    CAMERA_NAMES_LIST = new InOutArray<StringOutput>( 100, this );
    for( uint i = 0; i < 100; i++ )
    {
    ...
    START_SHARE_MODE.OnDigitalPush.Add( new InputChangeHandlerWrapper( START_SHARE_MODE_OnPush_77, true ) );
    STOP_SHARE_MODE.OnDigitalPush.Add( new InputChangeHandlerWrapper( STOP_SHARE_MODE_OnPush_78, true ) );
    ...
    AREA_SELECT_NEXT_BTN.OnDigitalPush.Add( new InputChangeHandlerWrapper( AREA_SELECT_NEXT_BTN_OnPush_83, true ) );
    AREA_SELECT_PREV_BTN.OnDigitalPush.Add( new InputChangeHandlerWrapper( AREA_SELECT_PREV_BTN_OnPush_84, true ) );
    AREA_SELECT.OnAnalogChange.Add( new InputChangeHandlerWrapper( AREA_SELECT_OnChange_85, true ) );
...
public UserModuleClass__AS__TOUCHPANEL_V1_7_1 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
...
const uint MULTIROOM_SELECT_BTN__DigitalInput__ = 539;
const uint KEYBOARD_CHAR_BTN__DigitalInput__ = 639;
...
const uint ALLOW_TIMER__DigitalOutput__ = 37;
const uint D_OUT__DigitalOutput__ = 38;
const uint A_OUT__AnalogSerialOutput__ = 44;
const uint S_OUT__AnalogSerialOutput__ = 144;
const uint SOURCE_LIST_IN_USE__DigitalOutput__ = 338;
...
const uint QUICKSOURCE_D_FB__DigitalOutput__ = 374;
const uint QUICKSOURCE_A_FB__AnalogSerialOutput__ = 416;
const uint QUICKSOURCE_S_FB__AnalogSerialOutput__ = 466;
const uint QUICKLIGHTS_D_FB__DigitalOutput__ = 424;
const uint QUICKLIGHTS_S_FB__AnalogSerialOutput__ = 516;
const uint QUICKCLIMATE_D_FB__DigitalOutput__ = 436;
const uint QUICKCLIMATE_S_FB__AnalogSerialOutput__ = 528;
const uint QUICKDOORLOCK_D_FB__DigitalOutput__ = 448;
const uint QUICKDOORLOCK_S_FB__AnalogSerialOutput__ = 532;
const uint QUICKWINDOWS_D_FB__DigitalOutput__ = 450;
const uint QUICKWINDOWS_S_FB__AnalogSerialOutput__ = 534;
const uint NAVIGATIONITEMENABLE__DigitalOutput__ = 462;
const uint NAVIGATIONITEMVISIBLE__DigitalOutput__ = 512;
const uint NAVIGATIONITEMICON__AnalogSerialOutput__ = 546;
const uint NAVIGATIONITEMTEXT__AnalogSerialOutput__ = 596;
const uint CONTROLLISTDIGITAL_FB__DigitalOutput__ = 562;
const uint CONTROLLISTSERIAL_FB__AnalogSerialOutput__ = 646;
const uint MULTIROOM_SELECT_FB__DigitalOutput__ = 662;
const uint MULTIROOM_SOURCE_LIST_TEXT__AnalogSerialOutput__ = 746;
const uint MULTIROOM_SOURCE_LIST_ICON__AnalogSerialOutput__ = 782;
const uint MULTIROOM_SCENE_NAMES__AnalogSerialOutput__ = 818;
const uint CAMERA_NAMES_LIST__AnalogSerialOutput__ = 842;
const uint ROOM_DISPLAYS_LIST__AnalogSerialOutput__ = 942;
const uint INTERCOM_NAMES_LIST__AnalogSerialOutput__ = 948;
const uint INTERCOM_LIST_ENABLE__DigitalOutput__ = 762;
const uint INTERCOM_LIST_VISIBLE__DigitalOutput__ = 812;
const uint DOORBELL_CHIME__DigitalOutput__ = 862;
const uint ROOMLISTITEMENABLE__DigitalOutput__ = 866;
